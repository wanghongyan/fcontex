...
<body style="background: #ddeded url(<?php echo URL_THEME; ?>images/bg-pattern-plain.jpg) repeat;">
	...
	<a id="fly-on-home" href="<?php echo URL_SITE; ?>" style="position: absolute; top: -1384px; left: -1389px;"><img border="0" src="<?php echo URL_THEME; ?>images/404.png" width="389" height="384" alt="404 not found" /></a>	
